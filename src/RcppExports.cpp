...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< IntegerVector >::type map_k_vector2(map_k_vector2SEXP);
    ...
    Rcpp::traits::input_parameter< std::string >::type extirpation_depen(extirpation_depenSEXP);
    ...
    Rcpp::traits::input_parameter< bool >::type speciation_rangesize_unlinked(speciation_rangesize_unlinkedSEXP);
    Rcpp::traits::input_parameter< bool >::type colonization_rangesize_unlinked(colonization_rangesize_unlinkedSEXP);
    ...
    Rcpp::traits::input_parameter< IntegerVector >::type time_slices(time_slicesSEXP);
    Rcpp::traits::input_parameter< IntegerVector >::type manual_speciation_events_timing(manual_speciation_events_timingSEXP);
    rcpp_result_gen = Rcpp::wrap(do_simulation(map_elevation_vector, map_k_vector, map_k_vector2, map_temperature_vector, map_temperature_vector2, extirpation_depen, colonization_depen_temperature, x_max, y_max, all_x, all_y, all_IDs, all_parents, all_births, all_deaths, all_traits, all_ranges, all_alleles, all_alleles_neutral, all_popsize, number_spp, the_seed, mutation_rate, percentage_flow, geneflow_rate, popchange_rate, the_gammas, the_mus, q, lambda, species_trait_state_gamma, sd_normal_distribution_traitevol, mean_normal_distribution_traitevol, sd_normal_distribution_pop_change, starting_time, simulated_time, max_spp, maximum_cycles, use_k, restiction_par, show_richness_map, v, alleles_adaptation_coef2, do_change_map_rates, vicariant_speciation, speciation_rangesize_unlinked, colonization_rangesize_unlinked, time_percent_stop_after_first_equilibrium_and_disturbance, time_slices, manual_speciation_events_timing));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_geneclade_do_simulation", (DL_FUNC) &_geneclade_do_simulation, 50},
